...
Muse.Utils.VimeoVideoHelper = function (a) {
    var b = [],
        ...
        d = function (a, c, f, d) {
            ...
            a = a.attr("src").split("?")[0];
            a.match(/^\w+\:\/\//gi) || (a = document.location.protocol + a);
            g.postMessage("{" + c + "}", a)
        },
        g = function (b) {
            data = null;
    ...
    window.addEventListener ?
        window.addEventListener("message", f, !1) : window.attachEvent("onmessage", f, !1);
    f = function () {};
        ...
        if (-1 != a) {
            ...
            for (var a = document.getElementsByTagName("meta"), b = 0, c = a.length; b < c; b++) {
                ...
                if ("generator" == d.getAttribute("name")) {
                    "2015.0.0.309" != d.getAttribute("content") && Muse.assets.outOfDate.push("museutils.js");
                    break
                }
            }
        }
